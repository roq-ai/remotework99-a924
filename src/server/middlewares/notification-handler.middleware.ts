...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  ...
  'job.update': { roles: ['freelancer'], key: 'job-updated', tenantPath: ['company', 'job'], userPath: [] },
  'job.delete': { roles: ['freelancer'], key: 'job-deleted', tenantPath: ['company', 'job'], userPath: [] },
  'application.create': {
    roles: ['employer'],
  ...
  'user.delete': { roles: ['administrator'], key: 'account-deleted', tenantPath: ['company', 'user'], userPath: [] },
};

const ownerRoles: string[] = ['administrator'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['employer', 'freelancer', 'administrator'];
